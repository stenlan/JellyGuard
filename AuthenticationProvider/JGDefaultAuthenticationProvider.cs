...
{
    /// <summary>
    /// Default JellyGuard password-based (and optional TOTP) authentication provider.
    /// </summary>
    public class JGDefaultAuthenticationProvider(
        IDbContextFactory<JellyfinDbContext> contextFactory,
        ILogger<JGDefaultAuthenticationProvider> logger,
        ...
        IPasswordChangeable
    {
        ...
        /// <inheritdoc />
        public override string Name => "JellyGuard Default";
