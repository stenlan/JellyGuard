...
namespace JellyGuard.AuthenticationProvider
{
    ...
    /// </summary>
    public class QuickConnectAuthenticationProvider(
        IUserManager userManager,
        IDbContextFactory<JellyfinDbContext> contextFactory)
        : AbstractExternallyTriggeredAuthenticationProvider<NoData, NoData, JGQuickConnectResult>(contextFactory, userManager)
    {
        /// <inheritdoc/>
        ...
        /// <inheritdoc/>
        protected override Task<AuthenticationResult> AuthenticateAttempt(JGQuickConnectResult attemptData)
        {
        ...
        /// <inheritdoc/>
        public async override Task<string> GenerateUpdateKey(JGQuickConnectResult data)
        {
