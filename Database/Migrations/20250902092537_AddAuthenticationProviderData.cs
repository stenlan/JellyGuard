...
namespace JellyGuard.Database.Migrations
{
    /// <inheritdoc />
    [Migration("20250902092537_AddAuthenticationProviderData")]
    public class AddAuthenticationProviderData : Migration
    {
        /// <inheritdoc />
...
INSERT INTO AuthenticationProviderData (AuthenticationProviderId, IsEnabled) VALUES ("JellyGuard.AuthenticationProvider.JGDefaultAuthenticationProvider", 1);
""");

            migrationBuilder.Sql("""
INSERT INTO UserAuthenticationProviderData (UserId, Data, AuthenticationProviderId) SELECT Id, '{"PasswordHash":"' || Password || '","MfaSetup":false,"TOTPSecret":null}', 'JellyGuard.AuthenticationProvider.JGDefaultAuthenticationProvider' FROM Users;
""");
